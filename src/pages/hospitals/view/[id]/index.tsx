...
function HospitalViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<HospitalInterface>(
    ...
    () =>
      getHospitalById(id, {
        relations: ['user', 'appointment', 'service'],
      }),
  );
              ...
              {hasAccess('appointment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/appointments/create?hospital_id=${data?.id}`}>
              ...
              {hasAccess('service', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/services/create?hospital_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
